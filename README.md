# flutter_range_slider extend from flutter_xlider

> Now supports null safety.

(Flutter Range Slider) A material design slider and range slider, horizontal and vertical, with rtl support and lots of options and customizations for flutter
## Now support flutter 3.0
